...
static const char *fonts[]          = { "Roboto Mono Bold Nerd Font Complete:size=12" };
static const char dmenufont[]       = "Roboto Mono Bold Nerd Font Complete:size=12";
// background color
...
//top bar color and active window vorder color
static const char col_cyan[]        = "#2E2775";
...
/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "6", "7", "zap", "música" };
...
static const char *playpause[]   = {"spotify_control", "PlayPause", NULL };
static const char *nextsong[] = {"spotify_control", "Next", NULL };
static const char *previoussong[] = {"spotify_control", "Previous", NULL };
